...
if %choice% == 1 (
  ...
  echo 5: Hacker (Everything in Conventional + Ftpiiu Everywhere, Geckiine, FT2SD, FS Dumper)
  ...
  cd appcache
  if %preset_choice% == 1 and not exist homebrew_launcher.zip curl --remote-name-all %zipsurl%%simple%
  goto start
) elif %choice% == 2 (
    cls
    cd temp
